...
its ordering over source ages from 0.10 to 1.60~s. Second, component probes
expose strong translation--rotation heterogeneity within the arm. The most
natural same-target disagreement metric ranks these components in the opposite
order from their behavioral sensitivity. Third, executable component-resolved
schedules improve success when gripper
