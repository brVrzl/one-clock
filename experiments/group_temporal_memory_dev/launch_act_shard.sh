...
pairing_methods="M0_h16,M1_shared_te_h16,M2_shared_cogact_h16,M3_group_cogact_h16"
methods="${GROUP_MEMORY_ACT_METHODS:-M2_shared_cogact_h16,M3_group_cogact_h16}"
...
"${python_bin}" "${script_dir}/run_act_group_memory.py" \
  --task "${task_key}" --methods "${pairing_methods}" --gpu "${gpu}" \
