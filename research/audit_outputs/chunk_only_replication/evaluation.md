...
3. Best learned test probability metrics: pooled AUROC=0.9223891353335086, AUPRC=0.9109292118487539, Brier=0.11361307338352075, ECE=0.031374945870731565, Brier Skill versus empirical=0.3043053509813264. The full pooled, group, offset, and macro reports are in `metrics.json` and the CSV files.
